...
const MainPage: NextPageWithLayout = () => {
  ...
  return (
    <>
      <NextSeo
        title="ZkCredit - Private Credit Scoring on Aleo"
        description="Borrow without revealing your financial history. Lend with verifiable privacy."
      />
      ...
      <div className="fixed inset-0 bg-primary bg-opacity-80 z-10 flex flex-col items-center justify-center px-4 py-16">
        ...
        <p className="mt-4 text-lg text-center text-primary-content max-w-lg">
          Decentralized lending using zero-knowledge proofs of creditworthiness on Aleo.
        </p>
